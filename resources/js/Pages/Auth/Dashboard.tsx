        ...
        <div className="lg:col-span-4 space-y-8 order-1 lg:order-2">
          <div className="bg-gradient-to-br from-terracotta to-[#8B310A] rounded-[2.5rem] p-8 terracotta-shadow relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h4 className="text-4xl font-headline font-bold text-white tracking-tight">{wordOfDay.term}</h4>
              <p className="text-white/60 font-mono text-xs tracking-widest">[{wordOfDay.pos}]</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-lg font-bold text-white">{wordOfDay.english}</div>
                  <div className="text-[10px] text-white/40 uppercase font-black tracking-widest">{wordOfDay.pos}</div>
                </div>
              </div>
